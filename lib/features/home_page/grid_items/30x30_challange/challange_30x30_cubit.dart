...
class Challange30x30StateLoaded extends Challange30x30State {
  final Challange30x30Intervention intervention;
...
class Challange30x30Cubit extends Cubit<Challange30x30State> {
  Challange30x30Cubit() : super(Challange30x30StateLoading()) {
    fetchData();
  }
