...
class Challenge30x30Page extends StatefulWidget {
  const Challenge30x30Page({Key? key}) : super(key: key);
  static const routeName = '/challange30x30';

  @override
  _Challenge30x30State createState() => _Challenge30x30State();
}

class _Challenge30x30State extends State<Challenge30x30Page> {
  late final Challenge30x30Cubit cubit;

  @override
  void initState() {
    super.initState();
    cubit = Challenge30x30Cubit();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('30x30 Challenge Progress'),
      ),
      body: BlocBuilder<Challenge30x30Cubit, Challange30x30State>(
        bloc: cubit,
  ...
  List<Widget> _buildListOfTiles(Challenge30x30Intervention data) {
  ...
  Widget _getProgressWidget({
    required ChallengeOneDayStats? value,
